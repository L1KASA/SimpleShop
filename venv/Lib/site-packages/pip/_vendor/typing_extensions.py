...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        ...
        *,
        ...
        The warning specified by ``categories`` will be emitted on use
        of deprecated objects. For functions, that happens on calls;
        for classes, on instantiation. If the ``categories`` is ``None``,
        ...
        def decorator(__arg: _T) -> _T:
            if categories is None:
                ...
                def __new__(cls, *args, **kwargs):
                    warnings.warn(__msg, categories=categories, stacklevel=stacklevel + 1)
