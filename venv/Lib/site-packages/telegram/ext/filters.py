...
class Document:
    ...
    class Category(MessageFilter):
        """Filters documents by their categories in the mime-type attribute.

        Args:
            categories (:obj:`str`): Category of the media you want to filter.
        ...
        def __init__(self, categories: str):
            ...
            super().__init__(name=f"filters.Document.Category('{self._categories}')")

        def filter(self, message: Message) -> bool:
            if message.document and message.document.mime_type:
                return message.document.mime_type.startswith(self._categories)
            return False
