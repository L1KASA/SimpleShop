...
def warn(
    ...
    categories: type[Warning] = PTBUserWarning,
    stacklevel: int = 0,
) -> None:
    """
    ...
    Args:
        ...
        categories (:obj:`type[Warning]`, optional): Specify the Warning class to pass to
    ...
    """
    warnings.warn(message, categories=categories, stacklevel=stacklevel + 1)
