...
class Recompiler:
    ...
    def _generate_cpy_const(self, is_int, name, tp=None, categories='const',
                            check_value=None):
        if (categories, name) in self._seen_constants:
            raise VerificationError(
                "duplicate declaration of %s '%s'" % (categories, name))
        self._seen_constants.add((categories, name))
        #
        prnt = self._prnt
