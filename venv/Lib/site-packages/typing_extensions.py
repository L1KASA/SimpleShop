...
if sys.version_info >= (3, 13, 3):
    ...
    class deprecated:
        ...
        The warning specified by *categories* will be emitted at runtime
        on use of deprecated objects. For functions, that happens on calls;
        for classes, on instantiation and on creation of subclasses.
        If the *categories* is ``None``, no warning is emitted at runtime.
        The *stacklevel* determines where the
        warning is emitted. If it is ``1`` (the default), the warning
        is emitted at the direct caller of the deprecated object; if it
        is higher, it is emitted further up the stack.
        Static type checker behavior is not affected by the *categories*
        ...
        def __init__(
            ...
            /,
            *,
            categories: typing.Optional[typing.Type[Warning]] = DeprecationWarning,
            stacklevel: int = 1,
        ) -> None:
        ...
        def __call__(self, arg: _T, /) -> _T:
            ...
            if categories is None:
                ...
                def __new__(cls, /, *args, **kwargs):
                    if cls is arg:
                        warnings.warn(msg, categories=categories, stacklevel=stacklevel + 1)
                ...
                raise TypeError(
                    "@deprecated decorator with non-None categories must be applied to "
